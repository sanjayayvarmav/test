        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
              <a href="#lightbox" data-slide-to="0"><img src="assets/images/gallery/diningspace/d1.jpg" class="img-thumbnail"></a>
            </div>
          </div>
        </div>
        <!-- Modal -->
                    ...
                    <div class="modal-body">
                        <div id="lightbox" class="carousel slide" data-ride="carousel" data-interval="5000" data-keyboard="true">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active"><img src="assets/images/gallery/diningspace/d1.jpg" class="w-100"
                                     alt=""></div>
