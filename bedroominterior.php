        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
              <a href="#lightbox" data-slide-to="0"><img src="assets/images/gallery/bedroom/b1.jpg" class="img-thumbnail"></a>
            </div>
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
              <a href="#lightbox" data-slide-to="1"><img src="assets/images/gallery/bedroom/b2.jpg" class="img-thumbnail"></a>
            </div>
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
              <a href="#lightbox" data-slide-to="2"><img src="assets/images/gallery/bedroom/b3.jpg" class="img-thumbnail"></a>
            </div>
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
              <a href="#lightbox" data-slide-to="3"><img src="assets/images/gallery/bedroom/b4.jpg" class="img-thumbnail"></a>
            </div>
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
              <a href="#lightbox" data-slide-to="4"><img src="assets/images/gallery/bedroom/b5.jpg" class="img-thumbnail"></a>
            </div>
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
              <a href="#lightbox" data-slide-to="5"><img src="assets/images/gallery/bedroom/b6.jpg" class="img-thumbnail"></a>
            </div>
            <div class="col-lg-4  p0" data-toggle="modal" data-target="#modal">
                    ...
                    <div class="modal-body">
                        <div id="lightbox" class="carousel slide" data-ride="carousel" data-interval="5000" data-keyboard="true">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active"><img src="assets/images/gallery/bedroom/b1.jpg" class="w-100"
                                     alt=""></div>
                                <div class="carousel-item"><img src="assets/images/gallery/bedroom/b2.jpg" class="w-100"
                                     alt=""></div>
                                <div class="carousel-item"><img src="assets/images/gallery/bedroom/b3.jpg" class="w-100"
                                     alt=""></div>
                                <div class="carousel-item"><img src="assets/images/gallery/bedroom/b4.jpg" class="w-100"
                                     alt=""></div>
                                <div class="carousel-item"><img src="assets/images/gallery/bedroom/b5.jpg" class="w-100"
                                     alt=""></div>
                                <div class="carousel-item"><img src="assets/images/gallery/bedroom/b6.jpg" class="w-100"
                                     alt=""></div>
